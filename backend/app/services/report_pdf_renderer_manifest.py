...
RENDERER_FILES = (
    ...
    "schemas/numeric_report_v3.py",
    "schemas/numeric_history_bundle.py",
    "schemas/numeric_history_prediction.py",
    "services/numeric_report_v3.py",
    "services/numeric_history_bundle.py",
    "services/numeric_history_features.py",
    "services/prediction_history_features.py",
    "services/synthetic_prediction_cases.py",
